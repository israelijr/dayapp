...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get themeOutono => 'Automne';
  ...
  @override
  String get themeOutonoLight => 'Outono (Clair)';

  @override
  String get themeOutonoDark => 'Outono (Sombre)';
  ...
  @override
  String get themeOutonoLightDescription => 'Tons chauds et terreux';

  @override
  String get themeOutonoDarkDescription => 'Version sombre du schéma Outono';
  ...
  String get backupZipExplanation =>
      'Génère un fichier ZIP que vous pouvez sauvegarder sur OneDrive, Google Drive, par e-mail ou à tout autre emplacement.';
  ...
  String get backupCreatedSuccess =>
      'Fichier de sauvegarde créé ! Utilisez le menu de partage pour l\'enregistrer.';
  ...
  String get helpHomeItemDesc =>
      'Affichez vos histoires sous forme de cartes, de liste ou sur le calendrier.';
  ...
  String get helpBiometricsDesc =>
      'Utilisez l\'empreinte digitale ou la reconnaissance faciale pour déverrouiller rapidement l\'application, si disponible sur votre appareil.';
  ...
  String get entryNotificationsInfo =>
      'Les entrées avec une date au moins 2 heures à l\'avance peuvent avoir des notifications planifiées.';
  ...
  String get biometricConfiguredInfo =>
      'La biométrie est configurée. Vous pouvez vous connecter avec votre empreinte digitale ou la reconnaissance faciale.';
  ...
  @override
  String get insightPositiveWordsTitle => 'Mots positifs';

  @override
  String get insightDifficultWordsTitle => 'Mots difficiles';
  ...
  String insightPositiveWords(String words) {
    return 'Mots qui apparaissent souvent dans vos histoires les plus positives : $words.';
  }

  @override
  String insightDifficultWords(String words) {
    return 'Mots qui apparaissent souvent dans vos histoires les plus difficiles : $words.';
  }
  ...
  String get backupInfoDialogContent =>
      '📦  Ce qui est inclus dans la sauvegarde\n• Toutes vos histoires (textes, photos, audios, vidéos)\n• Base de données de l\'application\n• Photos de chapitres\n\n📂  Comment stocker votre sauvegarde\nAprès la création, utilisez le menu de partage pour enregistrer le fichier où vous le souhaitez — OneDrive, Google Drive, e-mail ou tout autre service.\n\n🔒  Mot de passe de sauvegarde\nChaque sauvegarde que vous créez est chiffrée avec un mot de passe que vous définissez au moment de la création.\n\nCe mot de passe n\'est connu que de vous. Il n\'est stocké nulle part dans l\'application.\n\n⚠️  Si vous oubliez votre mot de passe, le fichier de sauvegarde sera définitivement inaccessible — même notre équipe de support ne pourra pas récupérer vos données.\n\nStockez toujours votre mot de passe de sauvegarde dans un endroit sûr en dehors de l\'application.';
