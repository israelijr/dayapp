...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get backupInfoDialogContent =>
      '📦  Cosa è incluso nel backup\n• Tutte le tue storie (testi, foto, audio, video)\n• Database dell\'app\n• Foto dei capitoli\n\n📂  Come conservare il backup\nDopo la creazione, usa il menu di condivisione per salvare il file dove preferisci — OneDrive, Google Drive, e-mail o qualsiasi altro servizio.\n\n🔒  Password del backup\nOgni backup che crei è crittografato con una password che definisci al momento della creazione.\n\nQuesta password è nota solo a te. Non viene memorizzata da nessuna parte nell\'app.\n\n⚠️  Se dimentichi la password, il file di backup sarà definitivamente inaccessibile — nemmeno il nostro team di supporto potrà recuperare i tuoi dati.\n\nConserva sempre la password del backup in un posto sicuro fuori dall\'app.';
